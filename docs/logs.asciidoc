...
The {ecs-logging-ruby-ref}/intro.html[`ecs-logging-ruby`] library can also be used to use the {ecs-logging-ref}/intro.html[ECS logging] format without an APM agent.
